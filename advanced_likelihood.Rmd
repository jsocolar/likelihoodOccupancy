...
The pointiwse likelihood of an occupancy model intrinsically exists at the level of closure-units, *not* at the level of visits. The reason for this is simply that the likelihood does not factor to independent multiplicative contributions at the level of individual visits. See for yourself; attempt to factor $\mathcal{L_i}$ above.  You can't.

As a result, cross-validation (even leave-one-out cross-validation) is properly performed by withholding data at the level of closure-units, not at the level of visits. 
